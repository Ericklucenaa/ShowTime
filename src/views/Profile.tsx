...
import { BarChart3, UploadCloud, LogOut, CheckCircle2, AlertTriangle, Camera } from 'lucide-react';
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '30px' }} className="profile-grid">
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '30px' }}>
          ...
          <section className="st-panel" style={{ padding: '24px' }}>
            ...
            {importStatus && (
              <div className="st-card animate-fade-in" style={{ padding: '12px 16px', marginTop: '16px', display: 'flex', gap: '10px', alignItems: 'start', background: importStatus.success ? 'rgba(16, 185, 129, 0.08)' : 'rgba(239, 68, 68, 0.08)', borderColor: importStatus.success ? 'rgba(16, 185, 129, 0.3)' : 'rgba(239, 68, 68, 0.3)' }}>
